// Mock API utility for DATS website
const API_BASE = window.API_BASE || '';

window.api = {
  async checkSafetya({ destination, date }) {
    try {
      if (API_BASE) {
      ...
      console.warn('Using mock safety data.');
    }
  ...
  async getLiveAlerts(layer = 'all') {
    try {
      ...
      console.warn('Using mock live alert data.');
    }
      ...
      options: [
        {
          ...
          duration: '1h 15m',
          distance: '62 km',
          summary: 'Expressway avoiding flood zone',
          advisory: 'Minor slowdown due to detour',
        },
        {
          risk: 'Moderate',
          duration: '1h 05m',
          distance: '58 km',
          summary: 'Shortest path near watch area',
          advisory: 'Monitor alerts en route',
        },
      ],
    };
  },
